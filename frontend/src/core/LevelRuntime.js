  ...
  spawnEntities() {
    ...
    getTaskObjectives(this.level).forEach(objective => {
      this.entityManager.add(new Checkpoint(this.scene, this.eventBus, {
        ...
        interactionRadius: objective.interactionRadius,
        promptRadius: objective.promptRadius,
        ...
        finalFeedbackText: objective.finalFeedbackText,
        finalObjective: objective.finalObjective,
        finalCompletedColor: objective.finalCompletedColor,
        finalCompleteGlow: objective.finalCompleteGlow,
        activeGlow: objective.activeGlow,
        inactiveGlow: objective.inactiveGlow,
        markerColor: objective.markerColor,
        activeColor: objective.activeColor,
        completedColor: objective.completedColor,
        routeHint: objective.routeHint,
