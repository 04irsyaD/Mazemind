...
export const level1 = {
  ...
  architecture: [
    ...
    officeProps.workstationClusterLeft({
      ...
      y: 5.25,
      roomId: 'main-workstation-hall',
      anchor: 'leftWorkstationRows',
      chairModelId: 'office-chair-basic',
      chairModelUrl: '/assets/models/office/office_chair_basic.glb',
      chairAssetTag: 'office-chair-basic',
      chairFallbackPrefab: 'procedural',
      chairModelScale: [1, 1, 1],
