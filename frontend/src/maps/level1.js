...
export const level1 = {
  ...
  architecture: [
    ...
    { type: 'glassWall', x: 3.12, y: 17.55, axis: 'x', length: 1.55, color: 0xb7d4dc, opacity: 0.16, frostedOpacity: 0.24, frameColor: 0x7e8b8e },
    { type: 'glassWall', x: 11.1, y: 17.55, axis: 'x', length: 1.45, color: 0xb7d4dc, opacity: 0.16, frostedOpacity: 0.24, frameColor: 0x7e8b8e },
    ...
    { type: 'glassWall', x: 20.85, y: 11.75, axis: 'x', length: 1.35, color: 0xb7d4dc, opacity: 0.16, frameColor: 0x72898d, frostedOpacity: 0.26 },
    { type: 'glassWall', x: 18.05, y: 16.55, axis: 'z', length: 2.2, color: 0xb7d4dc, opacity: 0.15, frameColor: 0x6f858a, frostedOpacity: 0.26 },
    { type: 'glassWall', x: 23.85, y: 17.35, axis: 'z', length: 1.55, color: 0xb7d4dc, opacity: 0.15, frameColor: 0x6f858a, frostedOpacity: 0.26 },
    { type: 'glassWall', x: 31, y: 10.65, axis: 'x', length: 6.2, color: 0xd0d6c8, opacity: 0.16, frameColor: 0x747d7a, frostedOpacity: 0.22, postSpacing: 1.25 },
    ...
    { type: 'column', x: 4.2, y: 17.55, radius: 0.13, height: 2.65, color: 0xa2adaf },
