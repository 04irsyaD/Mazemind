...
export const level1 = {
  ...
  sentientObjects: [],
  floorZones: [
    { id: 'front-reception', x1: 2, y1: 18, x2: 12, y2: 22, color: 0xb8bbb6, emissive: 0x151a19, emissiveIntensity: 0.045, roughness: 0.66, metalness: 0.05, height: 0, floorLineColor: 0x8f9896, floorLineOpacity: 0.24 },
    ...
    { id: 'main-workstation-hall', x1: 2, y1: 4, x2: 20, y2: 13, color: 0x8f9c9e, emissive: 0x0f1618, emissiveIntensity: 0.04, roughness: 0.84, height: 0, floorLineColor: 0x748185, floorLineOpacity: 0.2, floorLineStep: 2 },
    { id: 'archive', x1: 3, y1: 22, x2: 15, y2: 28, color: 0x5f6d75, emissive: 0x0b1016, emissiveIntensity: 0.055, roughness: 0.86, height: -0.03, floorLineColor: 0x4f5b62, floorLineOpacity: 0.16, floorLineStep: 2 },
    { id: 'checkpoint-chamber', x1: 17, y1: 11, x2: 24, y2: 19, color: 0x809aa0, emissive: 0x0c1b1f, emissiveIntensity: 0.07, roughness: 0.78, height: 0.08, floorLineColor: 0x6f858a, floorLineOpacity: 0.18 },
    { id: 'wrong-department', x1: 24, y1: 4, x2: 35, y2: 10, color: 0xa6aba2, emissive: 0x12140f, emissiveIntensity: 0.04, roughness: 0.78, height: 0.04, floorLineColor: 0x858b82, floorLineOpacity: 0.18, floorLineStep: 2 },
    { id: 'utility-break', x1: 18, y1: 22, x2: 28, y2: 28, color: 0x7f897d, emissive: 0x10140e, emissiveIntensity: 0.035, roughness: 0.86, height: 0, floorLineColor: 0x6e796e, floorLineOpacity: 0.14, floorLineStep: 2 },
    ...
    { id: 'fake-exit', x1: 37, y1: 12, x2: 42, y2: 18, color: 0xb8c7bf, emissive: 0x101a15, emissiveIntensity: 0.055, roughness: 0.68, height: -0.04, floorLineColor: 0x94a59d, floorLineOpacity: 0.2 },
    { id: 'final-route', x1: 34, y1: 21, x2: 42, y2: 28, color: 0x9fbfc3, emissive: 0x0b1d20, emissiveIntensity: 0.08, roughness: 0.68, height: -0.04, floorLineColor: 0x80a3a8, floorLineOpacity: 0.16, floorLineStep: 2 }
  ],
  wallDetailZones: [
  ...
  ceilingDetailZones: [
    ...
    { id: 'workstation-entry-ceiling', x1: 2, y1: 4, x2: 20, y2: 13, step: 2 },
    { id: 'archive-ceiling', x1: 3, y1: 22, x2: 15, y2: 28, step: 2 },
    { id: 'review-ceiling', x1: 17, y1: 11, x2: 24, y2: 19, step: 1.5 },
    { id: 'records-office-ceiling', x1: 24, y1: 4, x2: 35, y2: 10, step: 2 },
    { id: 'staff-ceiling', x1: 18, y1: 22, x2: 28, y2: 28, step: 2 },
    { id: 'exit-transfer-ceiling', x1: 34, y1: 12, x2: 42, y2: 28, step: 2 }
  ],
  guideStrips: [],
  navigationNodes: [],
  ...
  architecture: [
    ...
    { type: 'cubicleCluster', x: 4.2, y: 6.6, columns: 2, rows: 2, color: 0xaab4b7, deskColor: 0xc5c7c0, trimColor: 0x879396, monitorColor: 0x8eb4b8, monitorIntensity: 0.18, chairColor: 0x30383d },
    { type: 'cubicleCluster', x: 13.0, y: 6.6, columns: 2, rows: 2, color: 0xa2aeb2, deskColor: 0xbfc2bb, trimColor: 0x808d91, monitorColor: 0x84a9ae, monitorIntensity: 0.16, chairColor: 0x2d353a },
    { type: 'glassWall', x: 10.8, y: 13.2, axis: 'x', length: 3.0, color: 0xb7d4dc },
    ...
    { type: 'glassWall', x: 17, y: 15, axis: 'z', length: 4, color: 0xb7d4dc },
    { type: 'glassWall', x: 24, y: 15, axis: 'z', length: 4, color: 0xb7d4dc },
    ...
    { type: 'frame', x: 25, y: 15, axis: 'z', width: 2.7, color: 0x7a615a, emissive: 0x1b0603, emissiveIntensity: 0.12 },
    { type: 'frame', x: 37, y: 15, axis: 'z', width: 2.7, color: 0x90a79a, emissive: 0x07150d, emissiveIntensity: 0.08 },
    { type: 'beam', x: 31, y: 14, axis: 'x', length: 12, color: 0x72564f, emissive: 0x150302, emissiveIntensity: 0.12 },
    { type: 'beam', x: 31, y: 16, axis: 'x', length: 12, color: 0x72564f, emissive: 0x150302, emissiveIntensity: 0.12 },
    { type: 'column', x: 9, y: 12, radius: 0.13, height: 2.65, color: 0xa2adaf },
    { type: 'column', x: 15, y: 19, radius: 0.13, height: 2.65, color: 0xa2adaf },
    { type: 'column', x: 18, y: 12, radius: 0.13, height: 2.85, color: 0x829da6, emissive: 0x061b20, emissiveIntensity: 0.07 },
    { type: 'column', x: 24, y: 18, radius: 0.13, height: 2.85, color: 0x829da6, emissive: 0x061b20, emissiveIntensity: 0.07 },
