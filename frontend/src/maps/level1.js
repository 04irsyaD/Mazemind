...
export const level1 = {
  ...
  navigationNodes: [],
  areaLights: [
    { x: 7.6, y: 19.2, color: 0xd6e9e5, intensity: 0.55, distance: 14.5, height: 2.3 },
    { x: 8.8, y: 20.75, color: 0xb9c7c3, intensity: 0.19, distance: 10.5, height: 1.5 },
    { x: 3.75, y: 19.35, color: 0xb9c7c3, intensity: 0.15, distance: 8.5, height: 1.4 },
    { x: 5.45, y: 16.25, color: 0xcfe9e8, intensity: 0.52, distance: 11.25, height: 2.25 },
    { x: 5.6, y: 16.55, color: 0x7fcbd4, intensity: 0.23, distance: 5.8, height: 1.2 },
    { x: 9.6, y: 16.35, color: 0xb8c9c5, intensity: 0.17, distance: 8.5, height: 1.5 },
    { x: 8.2, y: 11.5, color: 0xcfe9e8, intensity: 0.32, distance: 13, height: 2.4 },
    { x: 8.25, y: 8.45, color: 0x9fb5b7, intensity: 0.18, distance: 10, height: 1.4 },
    { x: 13.5, y: 8.2, color: 0xb8d2d5, intensity: 0.18, distance: 10.5, height: 2.3 },
    { x: 3.1, y: 10.4, color: 0xaebec1, intensity: 0.12, distance: 11, height: 1.65 },
    { x: 18.2, y: 10.1, color: 0xa9bcc0, intensity: 0.11, distance: 11.5, height: 1.7 },
    { x: 3.2, y: 5.5, color: 0x9fb4ba, intensity: 0.09, distance: 9.5, height: 1.55 },
    { x: 18.1, y: 6.0, color: 0x9fb4ba, intensity: 0.1, distance: 10, height: 1.6 },
  ...
  ceilingLights: [
    { x: 7.3, y: 19.05, width: 0.74, depth: 0.1, color: 0xd6e9e5, fixtureColor: 0x9aa6a2, emissiveIntensity: 0.13, intensity: 0.36, distance: 10.25 },
    { x: 5.8, y: 16.05, width: 0.7, depth: 0.1, color: 0xcfe9e8, fixtureColor: 0x9caaa7, emissiveIntensity: 0.14, intensity: 0.35, distance: 9.5 },
    { x: 9.2, y: 15.0, width: 0.64, depth: 0.1, color: 0xcfe9e8, fixtureColor: 0x96a3a0, emissiveIntensity: 0.11, intensity: 0.24, distance: 8.4 },
    { x: 7.2, y: 11.2, width: 0.86, depth: 0.1, color: 0xcfe9e8, fixtureColor: 0x96a3a0, emissiveIntensity: 0.11, intensity: 0.24, distance: 10.25 },
    { x: 7, y: 7, width: 0.96, depth: 0.11, color: 0xcfe9e8, fixtureColor: 0x919c99, emissiveIntensity: 0.095, intensity: 0.18, distance: 9 },
    ...
    { x: 4.2, y: 10.2, width: 0.92, depth: 0.1, color: 0xc8dfdf, fixtureColor: 0x899693, emissiveIntensity: 0.09, intensity: 0.17, distance: 10 },
    { x: 10.4, y: 10.2, width: 0.92, depth: 0.1, color: 0xc8dfdf, fixtureColor: 0x899693, emissiveIntensity: 0.095, intensity: 0.18, distance: 10.5 },
    { x: 16.4, y: 10.2, width: 0.88, depth: 0.1, color: 0xbfd8dc, fixtureColor: 0x858f8e, emissiveIntensity: 0.08, intensity: 0.15, distance: 9.5 },
    { x: 4.2, y: 5.6, width: 0.88, depth: 0.1, color: 0xc1dadd, fixtureColor: 0x858f8e, emissiveIntensity: 0.08, intensity: 0.15, distance: 9.5 },
    { x: 10.4, y: 5.6, width: 0.92, depth: 0.1, color: 0xc6dddf, fixtureColor: 0x899693, emissiveIntensity: 0.085, intensity: 0.16, distance: 10 },
    { x: 16.4, y: 5.6, width: 0.86, depth: 0.1, color: 0xb9d2d6, fixtureColor: 0x808a89, emissiveIntensity: 0.075, intensity: 0.14, distance: 9 },
