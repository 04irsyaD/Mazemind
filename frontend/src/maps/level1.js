...
export const level1 = {
  ...
  architecture: [
    ...
    { type: 'glassWall', x: 11.05, y: 17.55, axis: 'x', length: 1.7, color: 0xb7d4dc },
    ...
    { type: 'glassWall', x: 17, y: 16.85, axis: 'z', length: 3.1, color: 0xb7d4dc },
    { type: 'glassWall', x: 24, y: 17.85, axis: 'z', length: 2.1, color: 0xb7d4dc },
    ...
    { type: 'column', x: 12, y: 17.55, radius: 0.13, height: 2.65, color: 0xa2adaf },
    { type: 'column', x: 17, y: 18.4, radius: 0.13, height: 2.85, color: 0x829da6, emissive: 0x061b20, emissiveIntensity: 0.07 },
    { type: 'column', x: 24, y: 18.9, radius: 0.13, height: 2.85, color: 0x829da6, emissive: 0x061b20, emissiveIntensity: 0.07 },
